...
void MyTitleBar::initControl()
{
	...
	m_pButtonMin->setIcon(QIcon(":/icon/icon/min.png"));
	m_pButtonRestore->setIcon(QIcon(":/icon/icon/min2max.png"));
	m_pButtonMax->setIcon(QIcon(":/icon/icon/max.png"));
	m_pButtonClose->setIcon(QIcon(":/icon/icon/close.png"));
